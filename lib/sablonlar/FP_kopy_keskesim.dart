...
class FP_KopyKes_Kesim extends StatefulWidget {
  ...
  final Size sekilModelSize2;
  final Offset sekilModelPosOffset;
  final Offset sekilModelPosOffset2;
  final Offset sekilModelToParentOffset;
  final Offset sekilModelToParentOffset2;

  const FP_KopyKes_Kesim({
    Key? key,
    ...
    required this.sekilModelPosOffset2,
    required this.sekilModelSize2,
    required this.sekilModelToParentOffset2,
  }) : super(key: key);

  @override
  State<FP_KopyKes_Kesim> createState() => FP_KopyKes_KesimState();
}

class FP_KopyKes_KesimState extends State<FP_KopyKes_Kesim>
                      ...
                      return Stack(
                        ...
                        children: [
                          ...
                          RelativePositionedTransition(
                            rect: RectTween(
                              begin: Rect.fromLTWH(
                                  widget.sekilModelPosOffset2.dx,
                                  widget.sekilModelToParentOffset2.dy,
                                  widget.sekilModelSize2.width,
                                  widget.sekilModelSize2.height),
                              end: Rect.fromLTWH(
                                  widget.sekilModelPosOffset2.dx-15,
                                  widget.sekilModelToParentOffset2.dy,
                                  widget.sekilModelSize2.width,
                                  widget.sekilModelSize2.height),
                            ).animate(
