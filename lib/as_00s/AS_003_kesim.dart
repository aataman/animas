...
class AS_003_Kesim extends StatefulWidget {
  const AS_003_Kesim(
      {Key? key,
  ...
  @override
  State<AS_003_Kesim> createState() => _AS_003_KesimState();
}

class _AS_003_KesimState extends State<AS_003_Kesim>
  ...
  void initState() {
    ...
    ).animate(CurvedAnimation(parent: _kesiciController, curve: Curves.bounceIn));
                          ...
                          RelativePositionedTransition(
                            rect: RectTween(
                              begin: Rect.fromLTWH(
                                  ...
                                  widget.sekilModel1ToParentPosOffset.dx - 2,
                                  widget.sekilModel1ToParentPosOffset.dy,
                                  widget.sekilModel1Size.width,
                                  widget.sekilModel1Size.height),
                            ).animate(
