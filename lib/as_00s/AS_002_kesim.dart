...
class AS_002_Kesim extends StatefulWidget {
  const AS_002_Kesim(
      {Key? key,
  ...
  @override
  State<AS_002_Kesim> createState() => _AS_002_KesimState();
}

class _AS_002_KesimState extends State<AS_002_Kesim>
  ...
  void initState() {
    ...
    ).animate(CurvedAnimation(parent: _kesiciController, reverseCurve: Curves.easeInOutBack,curve: Curves.bounceOut),);
