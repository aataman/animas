...
import 'AS_002_kesim.dart';


class AS_002 extends StatefulWidget {
  const AS_002({
    Key? key,
    this.svgAddress1 = "assets/daire_w500_h500.svg",
    this.basX1 = -0.045,
    this.bitx2 = 0.045,
  }) : super(key: key);
  ...
  @override
  State<AS_002> createState() => _AS_002State();
}

class _AS_002State extends State<AS_002> with TickerProviderStateMixin {
  ...
  void _kesimdenSonraGonder() {
    ...
    Navigator.push(
      context,
      PageRouteBuilder(
        pageBuilder: (_, __, ___) => AS_002_Kesim(
